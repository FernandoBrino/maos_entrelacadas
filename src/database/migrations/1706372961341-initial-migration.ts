...
export class initialMigration1706372961341 implements MigrationInterface {
  name = 'initialMigration1706372961341';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "user_events" ("userId" bigint NOT NULL, "eventId" bigint NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT '"2024-01-27T16:29:21.715Z"', CONSTRAINT "PK_4bc8864800651979b9d5c410127" PRIMARY KEY ("userId", "eventId"))`
    );
    await queryRunner.query(
      `CREATE TABLE "events" ("id" BIGSERIAL NOT NULL, "title" character varying NOT NULL, "description" character varying NOT NULL, "event_at" TIMESTAMP NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT '"2024-01-27T16:29:21.715Z"', "update_at" TIMESTAMP NOT NULL DEFAULT '"2024-01-27T16:29:21.716Z"', "start_time" TIMESTAMP NOT NULL, "end_time" TIMESTAMP NOT NULL, CONSTRAINT "PK_40731c7151fe4be3116e45ddf73" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "announcements" ("id" BIGSERIAL NOT NULL, "title" character varying NOT NULL, "description" character varying NOT NULL, "tags" text array, "created_at" TIMESTAMP NOT NULL DEFAULT '"2024-01-27T16:29:21.717Z"', "updated_at" TIMESTAMP NOT NULL DEFAULT '"2024-01-27T16:29:21.717Z"', CONSTRAINT "PK_b3ad760876ff2e19d58e05dc8b0" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "images" ("id" BIGSERIAL NOT NULL, "url" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT '"2024-01-27T16:29:21.717Z"', "updated_at" TIMESTAMP NOT NULL DEFAULT '"2024-01-27T16:29:21.717Z"', "eventId" bigint, "announcementId" bigint, CONSTRAINT "PK_1fe148074c6a1a91b63cb9ee3c9" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "genders" ("id" BIGSERIAL NOT NULL, "name" character varying, "created_at" TIMESTAMP NOT NULL DEFAULT '"2024-01-27T16:29:21.718Z"', "updated_at" TIMESTAMP NOT NULL DEFAULT '"2024-01-27T16:29:21.718Z"', CONSTRAINT "PK_529fb131dd4164c94529f53e19d" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "addresses" ("id" BIGSERIAL NOT NULL, "country" character varying NOT NULL, "state" character varying NOT NULL, "district" character varying NOT NULL, "street" character varying NOT NULL, "number" character varying NOT NULL, "zipcode" integer NOT NULL, "complement" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT '"2024-01-27T16:29:21.854Z"', "updated_at" TIMESTAMP NOT NULL DEFAULT '"2024-01-27T16:29:21.854Z"', CONSTRAINT "PK_745d8f43d3af10ab8247465e450" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "person" ("id" BIGSERIAL NOT NULL, "name" character varying NOT NULL, "birth_date" TIMESTAMP, "created_at" TIMESTAMP NOT NULL DEFAULT '"2024-01-27T16:29:21.854Z"', "updated_at" TIMESTAMP NOT NULL DEFAULT '"2024-01-27T16:29:21.854Z"', "cpf" integer, "addressId" bigint, "genderId" bigint, CONSTRAINT "REL_a793ed25458ce9bc1584889cb1" UNIQUE ("addressId"), CONSTRAINT "PK_5fdaf670315c4b7e70cce85daa3" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "users" ("id" BIGSERIAL NOT NULL, "username" character varying NOT NULL, "email" character varying NOT NULL, "password" character varying NOT NULL, "is_admin" boolean NOT NULL DEFAULT false, "status" character varying NOT NULL DEFAULT 'Voluntário', "cellphone" character varying, "created_at" TIMESTAMP NOT NULL DEFAULT '"2024-01-27T16:29:21.855Z"', "updated_at" TIMESTAMP NOT NULL DEFAULT '"2024-01-27T16:29:21.855Z"', "google_id" character varying, "facebook_id" character varying, "personId" bigint, "imageId" bigint, CONSTRAINT "REL_ddd0d20e45dbd0d1536dc08203" UNIQUE ("personId"), CONSTRAINT "REL_0b9cf86bd47b4393165e9bddf3" UNIQUE ("imageId"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
